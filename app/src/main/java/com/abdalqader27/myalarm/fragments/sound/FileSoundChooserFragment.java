...
import com.abdalqader27.myalarm.activities.FileChooserActivity;
...
public class FileSoundChooserFragment extends BaseSoundChooserFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<String> previousFiles = new ArrayList<>(Objects.requireNonNull(prefs.getStringSet(PREF_FILES, new HashSet<>())));
